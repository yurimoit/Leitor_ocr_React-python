...
export default function SideBar({ setOpenDetalharPaciente, isPage, setIsPage, isPageHome, setIsPageHome, isPageExames, setIsPageExames, isPageDashBoard, setIsPageDashBoard }) {
